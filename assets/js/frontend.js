/**
 * Frontend JavaScript para Replanta Author SEO
 * 
 * Interacciones frontend (opcional - minimal)
 */
...
(function() {
    ...
    /**
     * Lazy loading de imágenes de artículos relacionados
     * (WordPress ya lo hace con loading="lazy", esto es un fallback)
     */
    if ('IntersectionObserver' in window) {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            const lazyImages = document.querySelectorAll('.replanta-related-posts img[data-src]');
     ...
     */
    document.addEventListener('DOMContentLoaded', () => {
        const internalLinks = document.querySelectorAll('.replanta-author-box a[href^="#"], .replanta-related-posts a[href^="#"]');
    ...
    /**
     * Analytics tracking para clicks en author box
     */
    document.addEventListener('DOMContentLoaded', () => {
        const authorLinks = document.querySelectorAll('.replanta-author-box a, .btn-author-posts');
    ...
    /**
     * Añadir SVG icons al DOM (inline para evitar requests HTTP)
     */
    document.addEventListener('DOMContentLoaded', () => {
        const svgIcons = `
            <svg style="display:none;" xmlns="http://www.w3.org/2000/svg">
                ...
                <symbol id="icon-text" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <symbol id="icon-update" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
